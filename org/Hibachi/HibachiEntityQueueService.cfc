...
component extends="HibachiDAO" persistent="false" accessors="true" output="false" {
	...
	public void function insertEntityQueue(required string baseID, required string baseObject, string processMethod='', string entityQueueID = createHibachiUUID(),entityQueueType=''){
		...
		var sql =	"INSERT INTO
						SwEntityQueue (entityQueueID,entityQueueType,baseObject,baseID,processMethod,createdDateTime,createdByAccountID,modifiedByAccountID,modifiedDateTime,tryCount)
					VALUES
						(:entityQueueID,:entityQueueType,:baseObject,:baseID,:processMethod,:dateTimeNow,:accountID,:accountID,:dateTimeNow, 0)";
