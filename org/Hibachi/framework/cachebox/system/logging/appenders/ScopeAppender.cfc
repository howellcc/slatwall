...
**/
component accessors="true" extends="cachebox.system.logging.AbstractAppender"{
	...
	function init(
		...
		// Scope storage
		variables.scopeStorage = new cachebox.system.core.collections.ScopeStorage();
		// Scope Checks
	 ...
	 */
	function logMessage( required cachebox.system.logging.LogEvent logEvent ){
		var entry    = structnew();
