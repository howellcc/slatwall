...
<cfinterface extends="cachebox.system.cache.ICacheProvider" hint="The main interface to produce a ColdBox Application cache">
	...
	<!--- getColdbox --->
    <cffunction name="getColdbox" output="false" access="public" returntype="any" hint="Get the coldbox application reference as cachebox.system.web.Controller" doc_generic="cachebox.system.web.Controller">
    </cffunction>

	<!--- setColdbox --->
    <cffunction name="setColdbox" output="false" access="public" returntype="void" hint="Set the coldbox application reference">
    	<cfargument name="coldbox" type="any" required="true" hint="The coldbox application reference as type: cachebox.system.web.Controller" doc_generic="cachebox.system.web.Controller"/>
    </cffunction>

	<!--- getEventURLFacade --->
    <cffunction name="getEventURLFacade" output="false" access="public" returntype="any" hint="Get the event caching URL facade utility" doc_generic="cachebox.system.cache.util.EventURLFacade">
    </cffunction>
