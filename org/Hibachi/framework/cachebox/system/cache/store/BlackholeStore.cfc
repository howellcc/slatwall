...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" output="false" returntype="BlackholeStore" hint="Constructor">
		<cfargument name="cacheProvider" type="any" required="true" hint="The associated cache provider as cachebox.system.cache.ICacheProvider" doc_generic="cachebox.system.cache.ICacheProvider"/>
		<cfscript>
			// Store Fields
