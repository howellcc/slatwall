...
<cfinterface hint="The main interface for CacheBox object storages.">
	...
	<!--- getIndexer --->
	<cffunction name="getIndexer" access="public" returntype="any" output="false" hint="Get the store's pool metadata indexer structure" doc_generic="cachebox.system.cache.store.indexers.MetadataIndexer">
	</cffunction>
