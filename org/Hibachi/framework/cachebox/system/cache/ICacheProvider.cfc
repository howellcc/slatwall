...
<cfinterface hint="The main interface for a CacheBox cache provider object, you implement it so CacheBox can manage it for you.">
	...
	<!--- getStats --->
    <cffunction name="getStats" output="false" access="public" returntype="any" hint="Get the cache statistics object as cachebox.system.cache.util.ICacheStats" doc_generic="cachebox.system.cache.util.ICacheStats">
    </cffunction>
	...
	<!--- getCacheFactory --->
    <cffunction name="getCacheFactory" output="false" access="public" returntype="any" hint="Get the cache factory reference this cache provider belongs to" doc_generic="cachebox.system.cache.CacheFactory">
    </cffunction>
    ...
    <cffunction name="setCacheFactory" output="false" access="public" returntype="void" hint="Set the cache factory reference for this cache">
    	<cfargument name="cacheFactory" type="any" required="true" doc_generic="cachebox.system.cache.CacheFactory"/>
    </cffunction>
	...
	<!--- getObjectStore --->
    <cffunction name="getObjectStore" output="false" access="public" returntype="any" hint="If the cache provider implements it, this returns the cache's object store as type: cachebox.system.cache.store.IObjectStore" doc_generic="cachebox.system.cache.store.IObjectStore">
    </cffunction>
