...
<!------------------------------------------- ColdBox Application Related Operations ------------------------------------------>
    ...
    <cffunction name="setColdbox" output="false" access="public" returntype="void" hint="Set the coldbox application reference">
    	<cfargument name="coldbox" type="any" required="true" hint="The coldbox application reference as cachebox.system.web.Controller" doc_generic="cachebox.system.web.Controller"/>
